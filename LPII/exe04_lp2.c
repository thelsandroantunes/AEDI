	...
	for(i=0;i<tam;i++){
		for(j=0;j<strlen(vet[i]);j++){
			if((vet[i][j] == 'a') || (vet[i][j] == 'A')){
				...
				if((vet[i][j] == 'b') || (vet[i][j] == 'B')){
					pos[1]++;
			}else
				if((vet[i][j] == 'c') || (vet[i][j] == 'C')){
					pos[2]++;
			}else
				if((vet[i][j] == 'd') || (vet[i][j] == 'D')){
					pos[3]++;
			}else
				if((vet[i][j] == 'e') || (vet[i][j] == 'E')){
					pos[4]++;
			}else
				if((vet[i][j] == 'f') || (vet[i][j] == 'F')){
					pos[5]++;
			}else
				if((vet[i][j] == 'g') || (vet[i][j] == 'G')){
					pos[6]++;
			}else
				if((vet[i][j] == 'h') || (vet[i][j] == 'H')){
					pos[7]++;
			}else
				if((vet[i][j] == 'i') || (vet[i][j] == 'H')){
					pos[8]++;
			}else
				if((vet[i][j] == 'j') || (vet[i][j] == 'J')){
					pos[9]++;
			}else
				if((vet[i][j] == 'k') || (vet[i][j] == 'K')){
					pos[10]++;
			}else
				if((vet[i][j] == 'l') || (vet[i][j] == 'L')){
					pos[11]++;
			}else
				if((vet[i][j] == 'm') || (vet[i][j] == 'M')){
					pos[12]++;
			}else
				if((vet[i][j] == 'n') || (vet[i][j] == 'N')){
					pos[13]++;
			}else
				if((vet[i][j] == 'o') || (vet[i][j] == 'O')){
					pos[14]++;
			}else
				if((vet[i][j] == 'p') || (vet[i][j] == 'P')){
					pos[15]++;
			}else
				if((vet[i][j] == 'q') || (vet[i][j] == 'Q')){
					pos[16]++;
			}else
				if((vet[i][j] == 'r') || (vet[i][j] == 'R')){
					pos[17]++;
			}else
				if((vet[i][j] == 's') || (vet[i][j] == 'S')){
					pos[18]++;
			}else
				if((vet[i][j] == 't') || (vet[i][j] == 'T')){
					pos[19]++;
			}else
				if((vet[i][j] == 'u') || (vet[i][j] == 'U')){
					pos[20]++;
			}else
				if((vet[i][j] == 'v') || (vet[i][j] == 'V')){
					pos[21]++;
			}else
				if((vet[i][j] == 'w') || (vet[i][j] == 'W')){
					pos[22]++;
			}else
				if((vet[i][j] == 'x') || (vet[i][j] == 'X')){
					pos[23]++;
			}else
				if((vet[i][j] == 'y') || (vet[i][j] == 'Y')){
					pos[24]++;
			}else
				if((vet[i][j] == 'z') || (vet[i][j] == 'Z')){
					pos[25]++;
			}		
		}
	}
